def find_int_adjacent_to_symbol(input_str, true_gears=False):
    final = 0
    final_2 = 0
    input_arr = input_str.split('\n')
    line_len = len(input_arr[0])  # 140 in test
    prev_nums = []
    prev_gears = []
    prev_true_gears = []
    for x in range(len(input_arr)):
        line = input_arr[x]
        # process numbers and gears
        current_nums = []
        current_gears = []
        current_true_gears = []
        temp_num = 0
        ...
        for i in range(line_len + 1):
            if i < line_len:
                ...
                if char.isnumeric():
                    ...
                    if temp_num > 0:
                        current_nums.append((num_index - 1, temp_num, i))  # start index - 1, number, end index + 1
                        num_index = None
                        temp_num = 0
                    if char != '.':
                        current_gears.append(i)
                        if char == '*':
                            current_true_gears.append([i, 0, 1])  # number of times multiplied, multiplied num
            else:  # end of line, check if there is a number to be added
                if temp_num > 0:
                    current_nums.append((num_index - 1, temp_num, i))  # start index - 1, number, end index + 1
        # done processing, now sum based on gears
        for nums in prev_nums:
            check_range = range(nums[0], nums[2] + 1)
            for gear in current_gears:
                if gear in check_range:
                    final += nums[1]
                    break
            for true_gear in current_true_gears:
                if true_gear[0] in check_range:
                    true_gear[2] *= nums[1]
                    true_gear[1] += 1
                    break
        prev_nums.clear()
        for nums in current_nums:
            ...
            for gear in prev_gears:
                ...
                for gear in current_gears:
                    ...
                    prev_nums.append(nums)
            for true_gear in prev_true_gears:
                if true_gear[0] in check_range:
                    true_gear[2] *= nums[1]
                    true_gear[1] += 1
                    break
        ...
        if x == len(input_arr) - 1:
            for true_gear in current_true_gears:
                if true_gear[1] == 2:
                    final_2 += true_gear[2]
        prev_gears = current_gears
        prev_true_gears = current_true_gears
    if not true_gears:
        return final
    else:
        return final_2
...
if __name__ == '__main__':
    test = '''....401.............425.......323......791......697...............963............................................420........................
...*..................................%......#.....*....290.........................492.............656...@953.....................+830.....
...
.....30..............355...978...........67.........419........239..........732...............645..........................484........664...'''
    print(find_int_adjacent_to_symbol(test))
    print(find_int_adjacent_to_symbol(test, true_gears=True))
